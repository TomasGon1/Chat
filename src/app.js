...
//2) Instalamos las dependencias que necesitamos para generar nuestro chat: npm i express express-handlebars socket.io
...
io.on("connection", (socket) => {
    ...
    socket.on("message", data => {
        ...
        messages.push(data);
        //Utilizamos el metodo emit que nos permite emitir eventos desde el servido hacia el cliente.
